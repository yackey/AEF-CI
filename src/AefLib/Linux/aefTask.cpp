...
uint32_t              CAefTask::m_ntickspersec;
...
***************************************************************************/
AEF_STATUS CAefTask::Stop(uint32_t msWait)
{
...
*  \return AEF_SUCCESS
***************************************************************************/
AEF_STATUS CAefTask::Stop(CAefQueueTask* pTask, uint32_t msgID)
{
...
*
***************************************************************************/
bool CAefTask::WatchdogCheck(uint32_t *task_id)
{
    bool bCheck = true;
...
*
***************************************************************************/
uint32_t CAefTask::GetTimestamp()
{
    struct sysinfo si;
    sysinfo(&si);
    uint32_t nSec = si.uptime;
...
*
***************************************************************************/
uint32_t CAefTask::MsToTimeTicks(uint32_t ms)
{
    uint32_t nTps = (ms/1000) * CAefTask::m_ntickspersec;
    return nTps;
}
...
*
***************************************************************************/
void CAefTask::TaskDelay(uint16_t ms)
{
