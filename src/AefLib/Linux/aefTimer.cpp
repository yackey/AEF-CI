 ...
 *	\return 	Timer ID.
 ***************************************************************************/
AEF_TIMER_HANDLE CAefTimer::Start(uint32_t id, uint32_t ms, uint8_t type, void* pVoid)
{
 ...
 ***************************************************************************/
AEF_TIMER_HANDLE CAefTimer::Start(AEF_TIMER_TASK_ID timerTaskId, uint32_t id, uint32_t ms, uint8_t type, void* pVoid)
{
 ...
 ***************************************************************************/
bool CAefTimer::GetTimerClientInfo(AEF_TIMER_HANDLE hTimer, uint32_t& timerId, void*& pVoid)
{
    bool result = false;
    TimerMap::iterator it;
    AEF_TIMER_INFO* pTimerInfo;
