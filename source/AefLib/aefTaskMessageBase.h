/***************************************************************************/
/*!
**	\file  aefTaskMessage.h
**	\brief Defines the TaskMessage object.
**
**	Avtec, Inc.
...
*****************************************************************************/
#ifndef _aefTaskMessageBase_h
#define _aefTaskMessageBase_h
...
*
*/
class CAefTaskMessageBase
{
public:
    CAefTaskMessageBase(){};
    virtual ~CAefTaskMessageBase(){};
