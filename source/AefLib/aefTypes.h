...
// timer
#define AEF_TIMER_HANDLE  UNSIGNED32
...
#define AEF_TIMER_TASK_ID UNSIGNED32
...
typedef struct
{
    ...
    UNSIGNED32 LastRcv; // Last valid message received on socket
    UNSIGNED32 IPAddress;
    UNSIGNED16 Port;
    UNSIGNED8 bDelete; // indication that connection should be deleted
} VX_TCP_CLIENT_INFO;
