...
class CAefTask : public CAefTaskBase
{
    // Class Methods
public:
    CAefTask();
    ...
    virtual AEF_STATUS Stop(UNSIGNED32 msWait = AEF_WAIT_FOREVER);
    virtual AEF_STATUS Stop(CAefQueueTask* pTask, UNSIGNED32 msgID); 
    ...
    static UNSIGNED32 GetTimestamp();
    static UNSIGNED32 MsToTimeTicks(UNSIGNED32 ms);
    virtual void TaskDelay(UNSIGNED16 ms);
...
protected:
    ...
    virtual bool WatchdogCheck(UNSIGNED32 *task_id = NULL);
...
protected:
    ...
    static UNSIGNED32   m_ntickspersec;
